...
#two-col-entry(
  left-content: [
    #strong[Departamento Ingeniería de Sistems y Computación, Universidad de los Andes], Monitor del curso Introducción a la Programación
    #v(-design-text-leading)

    #v(design-highlights-top-margin);#highlights([Asistí en la enseñanza de fundamentos de programación a 20+ estudiantes fomentando buenas prácticas de programación y resolviendo dudas en proyectos de programación y manejo de datos.],)
  ],
  right-content: [
    Bogotá, Colombia
...
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Herramientas:] Excel, Git, ROS, Simulink, Fusion360, ETAP,  Typhoon HIL, PVsyst, HOMER Pro, QGIS]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
